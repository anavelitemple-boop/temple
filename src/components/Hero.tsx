...
export default function Hero({
  ...
  return (
    <section className="relative min-h-[55vh] md:h-[65vh] w-full flex flex-col justify-center overflow-hidden bg-charcoal py-4 sm:py-6">
      ...
      <div className="h-20 sm:h-24 z-10 shrink-0" />

      {/* Main Content Area */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 flex-grow self-center">
        {/* Hero Text */}
        <motion.div 
